...
type OutlierDetection struct {
	...
	// $hide_from_docs
	EnforcingConsecutive_5Xx *types.UInt32Value `protobuf:"bytes,8,opt,name=enforcing_consecutive_5xx,json=enforcingConsecutive5xx,proto3" json:"enforcing_consecutive_5xx,omitempty"`
	// The % chance that a host will be actually ejected when an outlier status is
	...
	// $hide_from_docs
	EnforcingConsecutiveGatewayFailure *types.UInt32Value `protobuf:"bytes,9,opt,name=enforcing_consecutive_gateway_failure,json=enforcingConsecutiveGatewayFailure,proto3" json:"enforcing_consecutive_gateway_failure,omitempty"`
	...
	// into account: consecutive_local_origin_failure,
	// enforcing_consecutive_local_origin_failure and
	// enforcing_local_origin_success_rate. Defaults to false.
	// $hide_from_docs
	SplitExternalLocalOriginErrors bool `protobuf:"varint,10,opt,name=split_external_local_origin_errors,json=splitExternalLocalOriginErrors,proto3" json:"split_external_local_origin_errors,omitempty"`
	// Number of consecutive locally originated failures before ejection occurs.
	// Defaults to 5. Parameter takes effect only when
	// split_external_local_origin_errors is set to true.
	// $hide_from_docs
	ConsecutiveLocalOriginFailure *types.UInt32Value `protobuf:"bytes,11,opt,name=consecutive_local_origin_failure,json=consecutiveLocalOriginFailure,proto3" json:"consecutive_local_origin_failure,omitempty"`
	// The % chance that a host will be actually ejected when an outlier status is
	...
	// Parameter takes effect only when split_external_local_origin_errors is set
	// to true.
	// $hide_from_doc
	EnforcingConsecutiveLocalOriginFailure *types.UInt32Value `protobuf:"bytes,12,opt,name=enforcing_consecutive_local_origin_failure,json=enforcingConsecutiveLocalOriginFailure,proto3" json:"enforcing_consecutive_local_origin_failure,omitempty"`
...
var fileDescriptor_31054629b619ca4b = []byte{
	...
	,
}
