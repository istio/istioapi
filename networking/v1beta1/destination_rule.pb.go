...
type LocalityLoadBalancerSetting struct {
	// Optional: only one of distribute, failover or topologyKeys can be set.
	...
	//
	// 1. endpoints match same [network, region, zone, subzone] attributes with the client proxy have the highest priority.
	// 2. endpoints have same [network, region, zone] but different [subzone] attributes with the client proxy have the secondary-level priority.
	// 3. endpoints have same [network, region] but different [zone, subzone] attributes with the client proxy have the third-level priority.
	// 4. endpoints have same [network] but different [region, zone, subzone] attributes with the client proxy have the third-level priority.
	// 5. all the other endpoints that does not match any key have the lowest priority.
	//
	// ```yaml
	// topologyKeys:
	...
	TopologyKeys []string `protobuf:"bytes,4,rep,name=topologyKeys,proto3" json:"topologyKeys,omitempty"`
...
func (m *LocalityLoadBalancerSetting) GetTopologyKeys() []string {
	if m != nil {
...
var fileDescriptor_31054629b619ca4b = []byte{
	...
	,
}
...
func (m *LocalityLoadBalancerSetting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TopologyKeys) > 0 {
		for iNdEx := len(m.TopologyKeys) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintDestinationRule(dAtA, i, uint64(len(m.TopologyKeys[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
