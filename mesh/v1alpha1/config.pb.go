...
type MeshConfig struct {
	...
	// The cipher suites for inbound TLS connections to workloads, delimited by comma.
	// For the ciphers, please refer to the Envoy BoringSSL FIPS cipher list on
	...
	TlsInboundWorkloadCipherSuites string `protobuf:"bytes,60,opt,name=tls_inbound_workload_cipher_suites,json=tlsInboundWorkloadCipherSuites,proto3" json:"tlsInboundWorkloadCipherSuites,omitempty"`
	// The default profile for the cipher suites of inbound TLS connections to workloads,
	// which is used when tls_inbound_workload_cipher_suites is empty.
	// When configuring the value of the default profile:
	// "default": means that the default profile will be used.
	// "restricted": means that the restricted profile will be used for higher security.
	DefaultProfileForTlsInboundWorkloadCipherSuites string   `protobuf:"bytes,61,opt,name=default_profile_for_tls_inbound_workload_cipher_suites,json=defaultProfileForTlsInboundWorkloadCipherSuites,proto3" json:"defaultProfileForTlsInboundWorkloadCipherSuites,omitempty"`
...
func (m *MeshConfig) GetTlsInboundWorkloadCipherSuites() string {
	if m != nil {
		return m.TlsInboundWorkloadCipherSuites
	}
	return ""
}

func (m *MeshConfig) GetDefaultProfileForTlsInboundWorkloadCipherSuites() string {
	if m != nil {
		return m.DefaultProfileForTlsInboundWorkloadCipherSuites
	}
	return ""
}
...
var fileDescriptor_b5c7ece76d5d5022 = []byte{
	...
	,
}
...
func (m *MeshConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DefaultProfileForTlsInboundWorkloadCipherSuites) > 0 {
		i -= len(m.DefaultProfileForTlsInboundWorkloadCipherSuites)
		copy(dAtA[i:], m.DefaultProfileForTlsInboundWorkloadCipherSuites)
		i = encodeVarintConfig(dAtA, i, uint64(len(m.DefaultProfileForTlsInboundWorkloadCipherSuites)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xea
	}
	if len(m.TlsInboundWorkloadCipherSuites) > 0 {
		i -= len(m.TlsInboundWorkloadCipherSuites)
		copy(dAtA[i:], m.TlsInboundWorkloadCipherSuites)
		i = encodeVarintConfig(dAtA, i, uint64(len(m.TlsInboundWorkloadCipherSuites)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xe2
...
func (m *MeshConfig) Size() (n int) {
	...
	l = len(m.TlsInboundWorkloadCipherSuites)
	if l > 0 {
		n += 2 + l + sovConfig(uint64(l))
	}
	l = len(m.DefaultProfileForTlsInboundWorkloadCipherSuites)
	if l > 0 {
		n += 2 + l + sovConfig(uint64(l))
	}
	if m.XXX_unrecognized != nil {
...
func (m *MeshConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 60:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TlsInboundWorkloadCipherSuites", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TlsInboundWorkloadCipherSuites = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 61:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DefaultProfileForTlsInboundWorkloadCipherSuites", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.DefaultProfileForTlsInboundWorkloadCipherSuites = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
