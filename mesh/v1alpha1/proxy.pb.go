...
type ECDSA_Curve int32

const (
	// NIST Curve P-256
	ECDSA_P256 ECDSA_Curve = 0
)

var ECDSA_Curve_name = map[int32]string{
	0: "P256",
}

var ECDSA_Curve_value = map[string]int32{
	"P256": 0,
}

func (x ECDSA_Curve) String() string {
	return proto.EnumName(ECDSA_Curve_name, int32(x))
}

func (ECDSA_Curve) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_5efecd978cf3d28d, []int{6, 0}
}
...
type ProxyConfig struct {
	...
	// Configuration used to generate and maintain workload certificates.
	WorkloadCertificate  *WorkloadCertificate `protobuf:"bytes,34,opt,name=workload_certificate,json=workloadCertificate,proto3" json:"workloadCertificate,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *ProxyConfig) GetWorkloadCertificate() *WorkloadCertificate {
	if m != nil {
...
type WorkloadCertificate struct {
	...
	// Default TTL duration is `24h0m0s`.
	Ttl *types.Duration `protobuf:"bytes,1,opt,name=ttl,proto3" json:"ttl,omitempty"`
	// The signature algorithm used.
	// Default is `RSA`. ECDSA is also supported.
	//
	// Types that are valid to be assigned to EncryptionAlgorithm:
	//	*WorkloadCertificate_Rsa
	//	*WorkloadCertificate_Ecdsa
	EncryptionAlgorithm  isWorkloadCertificate_EncryptionAlgorithm `protobuf_oneof:"encryption_algorithm"`
	XXX_NoUnkeyedLiteral struct{}                                  `json:"-"`
	XXX_unrecognized     []byte                                    `json:"-"`
	XXX_sizecache        int32                                     `json:"-"`
}
...
func (m *WorkloadCertificate) String() string { return proto.CompactTextString(m) }
...
func (m *WorkloadCertificate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_WorkloadCertificate.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
type isWorkloadCertificate_EncryptionAlgorithm interface {
	isWorkloadCertificate_EncryptionAlgorithm()
	MarshalTo([]byte) (int, error)
	Size() int
}

type WorkloadCertificate_Rsa struct {
	Rsa *RSA `protobuf:"bytes,2,opt,name=rsa,proto3,oneof"`
}
type WorkloadCertificate_Ecdsa struct {
	Ecdsa *ECDSA `protobuf:"bytes,3,opt,name=ecdsa,proto3,oneof"`
}

func (*WorkloadCertificate_Rsa) isWorkloadCertificate_EncryptionAlgorithm()   {}
func (*WorkloadCertificate_Ecdsa) isWorkloadCertificate_EncryptionAlgorithm() {}

func (m *WorkloadCertificate) GetEncryptionAlgorithm() isWorkloadCertificate_EncryptionAlgorithm {
	if m != nil {
...
func (m *WorkloadCertificate) GetTtl() *types.Duration {
	if m != nil {
		return m.Ttl
	}
	return nil
...
func (m *WorkloadCertificate) GetRsa() *RSA {
	if x, ok := m.GetEncryptionAlgorithm().(*WorkloadCertificate_Rsa); ok {
		return x.Rsa
	}
	return nil
}

func (m *WorkloadCertificate) GetEcdsa() *ECDSA {
	if x, ok := m.GetEncryptionAlgorithm().(*WorkloadCertificate_Ecdsa); ok {
		return x.Ecdsa
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*WorkloadCertificate) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*WorkloadCertificate_Rsa)(nil),
		(*WorkloadCertificate_Ecdsa)(nil),
	}
}

type RSA struct {
	// Default is `2048`. Valid range is `[2048, 4096]`.
	KeySize              uint32   `protobuf:"varint,1,opt,name=key_size,json=keySize,proto3" json:"keySize,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *RSA) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RSA) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RSA.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RSA) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RSA.Merge(m, src)
}
func (m *RSA) XXX_Size() int {
	return m.Size()
}
func (m *RSA) XXX_DiscardUnknown() {
	xxx_messageInfo_RSA.DiscardUnknown(m)
}

var xxx_messageInfo_RSA proto.InternalMessageInfo

func (m *RSA) GetKeySize() uint32 {
	if m != nil {
		return m.KeySize
	}
	return 0
...
type ECDSA struct {
	// The curve to use when generating the public and private key pair
	// Default is `P256`. Only P256 is supported for now.
	Curve                ECDSA_Curve `protobuf:"varint,1,opt,name=curve,proto3,enum=istio.mesh.v1alpha1.ECDSA_Curve" json:"curve,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}

func (m *ECDSA) Reset()         { *m = ECDSA{} }
func (m *ECDSA) String() string { return proto.CompactTextString(m) }
func (*ECDSA) ProtoMessage()    {}
func (*ECDSA) Descriptor() ([]byte, []int) {
	return fileDescriptor_5efecd978cf3d28d, []int{6}
}
func (m *ECDSA) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ECDSA) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ECDSA.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ECDSA) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ECDSA.Merge(m, src)
}
func (m *ECDSA) XXX_Size() int {
	return m.Size()
}
func (m *ECDSA) XXX_DiscardUnknown() {
	xxx_messageInfo_ECDSA.DiscardUnknown(m)
}

var xxx_messageInfo_ECDSA proto.InternalMessageInfo

func (m *ECDSA) GetCurve() ECDSA_Curve {
	if m != nil {
		return m.Curve
	}
	return ECDSA_P256
...
func init() {
	...
	proto.RegisterEnum("istio.mesh.v1alpha1.ECDSA_Curve", ECDSA_Curve_name, ECDSA_Curve_value)
	...
	proto.RegisterType((*WorkloadCertificate)(nil), "istio.mesh.v1alpha1.WorkloadCertificate")
	proto.RegisterType((*RSA)(nil), "istio.mesh.v1alpha1.RSA")
	proto.RegisterType((*ECDSA)(nil), "istio.mesh.v1alpha1.ECDSA")
...
var fileDescriptor_5efecd978cf3d28d = []byte{
	...
	,
}
...
func (m *ProxyConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.WorkloadCertificate != nil {
		{
			size, err := m.WorkloadCertificate.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *WorkloadCertificate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EncryptionAlgorithm != nil {
		{
			size := m.EncryptionAlgorithm.Size()
			i -= size
			if _, err := m.EncryptionAlgorithm.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *WorkloadCertificate_Rsa) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *WorkloadCertificate_Rsa) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Rsa != nil {
		{
			size, err := m.Rsa.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *WorkloadCertificate_Ecdsa) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *WorkloadCertificate_Ecdsa) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Ecdsa != nil {
		{
			size, err := m.Ecdsa.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RSA) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.KeySize != 0 {
		i = encodeVarintProxy(dAtA, i, uint64(m.KeySize))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ECDSA) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ECDSA) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ECDSA) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Curve != 0 {
		i = encodeVarintProxy(dAtA, i, uint64(m.Curve))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *WorkloadCertificate_Rsa) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *WorkloadCertificate_Ecdsa) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ProxyConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 34:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WorkloadCertificate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.WorkloadCertificate == nil {
				m.WorkloadCertificate = &WorkloadCertificate{}
			}
			if err := m.WorkloadCertificate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *WorkloadCertificate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.EncryptionAlgorithm = &WorkloadCertificate_Rsa{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.EncryptionAlgorithm = &WorkloadCertificate_Ecdsa{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProxy(dAtA[iNdEx:])
...
func (m *RSA) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RSA: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RSA: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *ECDSA) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ECDSA: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ECDSA: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Curve |= ECDSA_Curve(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
